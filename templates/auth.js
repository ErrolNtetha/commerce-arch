 ...
 * Author: Moobi Kabelo
 * Date: 2022-06-22
 * Project: commerce-arch/templates/auth.js
...
export const passwordResetEmail = (fullName, token) => {
  const email = {
    body: {
      title: "Password Reset",
      intro: `Hi ${fullName}, a password reset request has been sent.`,
      action: {
        instructions:
      ...
      outro:
        "Need help, or have questions? Just reply to support@domain.com, we'd love to help.",
      signature: false,
    },
  };
